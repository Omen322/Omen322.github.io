// JavaScript Document
	...
	$(document).ready(function() {
        ...
        language: 'cm',
        url: '../../../../dsathemes.us3.list-manage.com/subscribe/post@u=af1a6c0b23340d7b339c085b4&id=344a494a6e'
		...
		$("#show_details_standard").click( function(event) {
		...
		$("#show_details_euro").click( function(event) {
    		var ul = $(this).parent().next();
			if ( ul.is(":visible") == true ) {
				ul.fadeOut(500);
			} else {
		...
		$("#show_details_gofro").click( function(event) {
    		var ul = $(this).parent().next();
			if ( ul.is(":visible") == true ) {
				ul.fadeOut(500);
			} else {
		...
		$("#show_details_double_wall").click( function(event) {
    		var ul = $(this).parent().next();
			if ( ul.is(":visible") == true ) {
				ul.fadeOut(500);
			} else {
		...
		$(".read-more a.buy").click( function(event) {
			var form = $(this).closest(".tab-pane").find("form");
			$("#shadow").show();
			var topForm = $(this).offset().top - $("#about").height() - $("#intro-main").height() - form.height();
			form.css({"top":topForm+"px"});
			
			var product_name = $(this).closest(".speaker").find(".speaker-img-meta").find("h4").text();
			form.find("input.product_name").val(product_name);
